  ...
  return (
    <>
      <style>{`
        ...
        /* En móvil cuando no ha scrolleado, letras blancas */
        @media (max-width: 767px) {
          .header-bar.top .logo-title { color: white; }
          .header-bar.top .logo-subtitle { color: rgba(255,255,255,0.75); }
          .header-bar.scrolled .logo-title { color: white; }
          .header-bar.scrolled .logo-subtitle { color: #74c69d; }
        }
        ...
        /* Texture/pattern de fondo del drawer */
        .drawer::before {
          content: '';
          position: absolute;
          inset: 0;
          background-image: radial-gradient(circle at 20% 80%, rgba(82,183,136,0.12) 0%, transparent 50%),
          ...
          <div className="header-inner">
            ...
            <a href="#inicio" className="logo">
              ...
              <div className="logo-text">
                <span className="logo-title">araucaniaviajes</span>
                <span className="logo-subtitle">La Araucanía</span>
              </div>
            </a>
        ...
        <div className={`drawer ${isDrawerOpen ? 'open' : ''}`}>
          <div className="drawer-header">
            <div className="drawer-logo">
              ...
              <span className="drawer-logo-text">araucaniaviajes</span>
            </div>
